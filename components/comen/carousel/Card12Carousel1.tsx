...
export default function Card12Carousel1({
    number,
    cards,
    title,
    description,
    ...
    return (
        <>
            <div className="relative -mt-[100px] card-12-carousel-1">
            ...
            <style dangerouslySetInnerHTML={{
                __html: `
                       @media (min-width: 768px) { 
                        .card-12-carousel-1 .swiper-pagination { 
                            display: none; 
                        }
                    }

                    .card-12-carousel-1 .swiper-wrapper{
                            padding-bottom: 16px;
                        }
                    ...
                    .card-12-carousel-1 .swiper-slide{
                            height: auto;
                            display: flex;
                        }
