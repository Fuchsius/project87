...
export default function Card6Carousel1({ cards }: { cards: any[] }) {
    ...
    return (
        <div className='w-full card-6-carousel-1'>
            {/* title and button */}
            <div className='w-full relative '>
                <Title2 title="Stylish Hand-picked Hotels" className='' />
                <div className='w-full flex items-center relative'>
                    ...
                    <div className='w-full md:pr-28 pr-0'>
                        <p className='text-left mt-2'>
                            Stay at top rated hotels in desirable locations with great service and comfortable beds. Hotel of comparable standard and location
                            may be utilized.
                        </p>
                    </div>
                </div>
            ...
            <div className='w-full mt-4'>
                ...
                >
                    {groupedCards.map((group: any[], slideIndex: number) => (
                        <SwiperSlide key={slideIndex}>
                            <div className='grid gap-4'>
                                {group.map((card: any, cardIndex: number) => (
                                    <Card6
                                        key={`${slideIndex}-${cardIndex}-${card.day ?? card.title ?? cardIndex}`}
                                        image={card.image}
                                        title={card.title}
                                        day={card.day}
            ...
            <style dangerouslySetInnerHTML={{
                __html: `
                    @media (min-width: 768px) { 
                        .card-6-carousel-1 .swiper-pagination { 
                            display: none; 
                        }
                    }

                    .card-6-carousel-1 .swiper-wrapper{
                            padding-bottom: 16px;
                        }
