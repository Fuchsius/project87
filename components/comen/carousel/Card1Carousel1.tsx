...
export default function Card1Carousel1({ cards, title, description, bgColor1, bgColor2, size0 = 1, size768 = 2, size1024 = 3, size1280 = 3, minSize = 3, classNameTitle, classNameDescription }: { cards: any[]; title: string; description: string; bgColor1: string | undefined; bgColor2: string | undefined; size0?: number; size768?: number; size1024?: number; size1280?: number; minSize?: number; classNameTitle: string; classNameDescription: string }) {
    ...
    return (
        <>
            <div className="relative -mt-[140px] card-1-carousel-1">
            ...
            <style dangerouslySetInnerHTML={{
                __html: `
                        .card-1-carousel-1 .swiper-wrapper{
                            padding-bottom: 16px;
                        }
                        ...
                        .card-1-carousel-1 .swiper-slide{
                            height: auto;
                            display: flex;
                        }
