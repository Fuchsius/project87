...
export default function Card14Carousel1({ cards }: { cards: any[] }) {
    ...
    return (
        <div className='w-full card-14-carousel-1'>
            {/* title and button */}
            <div className='w-full relative '>
                <Title2 title="Unique TGT Experiences" className='' />
                <div className='w-full flex items-center relative'>
                    ...
                    <div className='w-full md:pr-28 pr-0'>
                        <p className='text-left mt-2'>
                            Discover destinations with engaging Local Experts, gain exclusive access to iconic sites, and participate in fun activities with our Unique TGT Experiences.
                        </p>
                    </div>
                </div>
                    ...
                    {cards.map((card: any, index: number) => (
                        ...
                        <SwiperSlide key={index}>
                            <Card14
                                ...
                                classNameImage={card.classNameImage} />
                        </SwiperSlide>
            ...
            <style dangerouslySetInnerHTML={{
                __html: `
                            ...
                            .card-14-carousel-1 .swiper-wrapper{
                                padding-bottom: 46px;
                            }
                    ` }} />
        </div>
