...
export default function Card3Carousel1({ cards, title, description, size0, size768, size1024, size1280, minSize, classNameTitle, classNameDescription }: { cards: any[]; title: string; description?: string; size0: number; size768: number; size1024: number; size1280: number; minSize: number; classNameTitle: string; classNameDescription?: string; }) {
    ...
    return (
        <>
            <div className="relative card-3-carousel-1">
                {/* title and button */}
            ...
            <style dangerouslySetInnerHTML={{
                __html: `
                        .card-3-carousel-1 .swiper-wrapper{
                            padding-bottom: 16px;
                        }
                        ...
                        .card-3-carousel-1 .swiper-slide{
                            height: auto;
                            display: flex;
                        }
