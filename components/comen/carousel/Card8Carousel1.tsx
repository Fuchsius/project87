...
const Card8Carousel1 = ({ cards }: { cards: any[] }) => {
    ...
    return (
        <div className='w-full card-8-carousel-1'>
            {/* title and button */}
            ...
            <style dangerouslySetInnerHTML={{
                __html: `
                    @media (min-width: 768px) { 
                        .card-8-carousel-1 .swiper-pagination { 
                            display: none; 
                        }
                    }

                    .card-8-carousel-1 .swiper-wrapper{
                            padding-bottom: 16px;
                        }
