...
export default function Card10Carousel1({ cards }: { cards: any[] }) {
    ...
    return (
        <div className='w-full card-10-carousel-1'>
            {/* title and button */}
            <div className='w-full relative flex items-center justify-center'>
                <Title2 title="Holiday Style" className='!text-center' />
            ...
            <style dangerouslySetInnerHTML={{
                __html: `
                    @media (min-width: 768px) { 
                        .card-10-carousel-1 .swiper-pagination { 
                            display: none; 
                        }
                    }

                    @media(max-width:768px){
                        .card-10-carousel-1 .swiper-wrapper{
                            padding-bottom: 46px;
                        }
                    }
                ` }} />
