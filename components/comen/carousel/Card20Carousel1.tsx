...
export default function Card20Carousel1({ cards, title, button, classNameTitle, classNameButton,classNameDescription }: { cards: any[]; title: string; button?: string; classNameTitle?: string; classNameButton?: string; bgColor?: string; classNameDescription?: string }) {
    ...
    return (
        <div className={`w-full card-20-carousel-1 `}>
            {/* title and button */}
            <div className='w-full relative '>
                ...
                <div className='w-full flex items-center relative' >
                    ...
                    {/* description */}
                    <div className='w-full md:px-28 px-0 flex items-center justify-center gap-2'>
                        <p className={`text-center ${classNameDescription}`}>Verified by</p>
            ...
            <style dangerouslySetInnerHTML={{
                __html: `
                    ...
                    .card-20-carousel-1 .swiper-wrapper{
                        padding-bottom: 16px;
                    }
                    ...
                    .card-20-carousel-1 .swiper-slide{
                            height: auto;
                            display: flex;
                        }
