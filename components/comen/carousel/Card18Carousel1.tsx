...
export default function Card18Carousel1({ cards, title, description, classNameTitle, classNameDescription }: { cards: any[], title: string, description: string, classNameTitle: string, classNameDescription: string }) {
    ...
    return (
        <div className='w-full card-18-carousel-1'>
            {/* title and button */}
            ...
            {/* cards */}
            <div className='w-full lg:mt-0 md:mt-8 mt-0'>
                <Swiper
            ...
            <style dangerouslySetInnerHTML={{
                __html: `
                        .card-18-carousel-1 .swiper-wrapper{
                            padding-bottom: 16px;
                        }
                        ...
                        .card-18-carousel-1 .swiper-slide{
                            height: auto;
                            display: flex;
                        }
