...
export default function Card33({ image, title, description, button, buttonVariant = "default", classNameTitle, classNameDescription }: { image: string; title: string; description: string; button: string; buttonVariant?: ButtonProps['variant']; classNameTitle?: string; classNameDescription?: string }) {
    return (
