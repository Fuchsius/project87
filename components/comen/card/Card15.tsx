...
export default function Card15({ image, title, locations, description, button, buttonVariant = "outline", classNameTitle, classNameDescription }: { image: string; title: string; locations: string; description: string; button: string; buttonVariant?: ButtonProps['variant']; classNameTitle?: string; classNameDescription?: string }) {
    return (
        <div className='w-full'>
            <div className='w-full md:grid md:grid-cols-2 block'>
                ...
                <div className='w-full lg:pl-24 md:pl-12 pl-0 md:mt-0 mt-8 flex flex-col justify-evenly gap-4'>
                    <div>
