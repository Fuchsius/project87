...
export default function Section22({ data }: { data: any[] }) {
            ...
            <div className="mt-12 space-y-2">
                {data.map((faq: any, index: number) => (
                    <div
                        ...
                        className={`border overflow-hidden transition-all ${openAccordions.includes(index) ? 'border-myblue' : 'border-[#E6E6E6]'}`}
                    >
                        <button
                        ...
                        >
                            ...
                            <div className={`w-8 h-8 min-h-8 min-w-8 flex items-center justify-center rounded-full bg-[#E6E6E6] text-textcolor1`}>
