...
export default function page() {
    ...
    const card19Carousel1Data1 = [
        {
            image: "assets/images/travel-styles-comfort/expect-1.png",
            title: "EFFORTLESSLY",
            subTitle: "Simple",
            description: "Family run guesthouses, friendly homestays. where locals become friends, and sometimes sleeping outside under the stars. Rooms that are clean, real hospitality, and all the basics you need, but not the fancy extras you don't.",
            classNameTitle: "",
            classNameSubTitle: "",
            classNameDescription: ""
        },
        {
            image: "assets/images/travel-styles-comfort/expect-2.png",
            title: "Local",
            subTitle: "Meals",
            description: "Meals made at home and shared at family tables, neighborhood restaurants where locals hang out, and simple breakfast spreads that feel so familiar. Real flavors, honest portions, and a warm atmosphere that makes people feel welcome.",
            classNameTitle: "",
            classNameSubTitle: "",
            classNameDescription: ""
        },
        {
            image: "assets/images/travel-styles-comfort/expect-3.png",
            title: "RELAXED",
            subTitle: "Starts",
    ...
    const card3Carousel3Data1 = [
        {
            type: "3",
            image: "assets/images/travel-styles-comfort/where-you-stay-1.png",
            title: "Blackpool Hotel",
            title2: "St. Andrew's Drive, Nuwara Eliya, Sri Lanka",
            description: "A charming colonial hotel offering comfortable accommodation with English country house atmosphere. Traditional rooms feature mountain views and classic furnishings, while the peaceful gardens provide relaxation away from town bestie. The intimate setting and personalized service create authentic hill station experiences. Stay here on",
            link: "#",
        ...
        {
            type: "3",
            image: "assets/images/travel-styles-comfort/where-you-stay-2.png",
            title: "The Hill Club",
    ...
    const card1Carousel1Data = [
        {
            image: "assets/images/travel-styles-comfort/travel-styles-1.png",
            title: "Luxury",
        ...
        {
            image: "assets/images/travel-styles-comfort/travel-styles-2.png",
            title: "Signature",
        ...
        {
            image: "assets/images/travel-styles-comfort/travel-styles-3.png",
            title: "Premium",
    ...
    return (
        ...
        <div className='w-full'>
            ...
            <div className='mx-auto w-full'>
                <Hero2
                    image="assets/images/travel-styles-comfort/hero.jpg"
                    title="Comfort"
                    description="For travellers on a budget"
                    type={1}
                    button=""
                    buttonLink=""
                    imageClassName=""
            ...
            <div className='w-full mt-12'>
                <Section3
                    title="Elevated experiences, down to earth"
                    description1=""
                    description2={`It doesn't have to be hard to remember a trip. Our Comfort travel is all about how beautiful simplicity can be. It includes carefully picked places to stay that are both high-quality and affordable. These aren't just places to sleep; they're where you start real adventures. You can focus on what really matters, making those spontaneous moments that become your favourite travel stories, because you have great locations, real service, and all the basics taken care of.`}
                    button=""
                    buttonLink=""
                    titleClassName=""
            ...
            <div className='my-container mt-12'>
                <div className='w-full grid grid-cols-1 md:grid-cols-2 items-center'>
                    <div className='order-2 md:order-1 w-full lg:pr-24 md:pr-12 pr-0 md:mt-0 mt-8'>
                        <div className='w-full'>
                            <Title2 title="What is Comfort travel" className='text-center'></Title2>
                            ...
                            <div className=''>
                                <p
                                    ...
                                    dangerouslySetInnerHTML={{
                                        __html:
                                            "Comfort means taking a trip that puts quality and value first without making any compromises. Our carefully chosen 3-star hotels have clean, well-furnished rooms in great locations, making sure you're perfectly positioned to explore while enjoying reliable amenities and attentive service. Each property has a mix of modern amenities and authentic local charm, making it a great place to start your adventures. You have more freedom with this travel style, both in terms of time and money, so you can spend your money on the things that matter most to you."
                                    }}
                                ></p>
                            </div>
                    ...
                    <div className='w-full order-1 md:order-2'>
                        <img src="assets/images/travel-styles-comfort/comfort-travel.png" alt="" className='w-full aspect-video object-cover rounded-md' />
                    </div>
                </div>
            </div>
