    ...
    return (
        ...
        <div className='w-full'>
            ...
            <div className='mt-12 my-container'>
                <Title2 title='After your trip' className='text-center ' ></Title2>
                <p className='mt-2 description text-center font-sourceSerif whitespace-pre-line'>Your Travelgate tour is over, but you still have questions about what to do next. Here are some of the most common questions we get about what happens after your tour.</p>
            </div>
