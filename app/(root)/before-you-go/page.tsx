    ...
    return (
        ...
        <div className='w-full'>
            ...
            <div className='mt-12 my-container'>
                <Title2 title='Before you book' className='text-center ' ></Title2>
                <p className='mt-2 description text-center font-sourceSerif whitespace-pre-line'>You might have a lot of questions about what it's like to travel with us right now before you book your Travelgate tour. To give you peace of mind that booking and travelling with us is the right choice, we've answered the questions we get asked the most below.</p>
            </div>
