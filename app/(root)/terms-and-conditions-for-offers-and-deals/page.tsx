        ...
        <div className='w-full'>
            ...
            <div className='w-full py-2'>
                <Breadcrumb items={[
                    ...
                    { label: "Terms and Conditions for Offers and Deals" },
                ]} />
            </div>

            <div className='w-full bg-myred2'>
                <div className='my-container md:h-[396px] h-[163px] flex items-center justify-center'>
                    <h1 className={`text-center text-white lg:text-5xl md:text-[40px] text-[28px] font-bold font-sourceSerif `}>Terms and Conditions for Offers and Deals</h1>
                </div>
            </div>

            <div className='mt-12 my-container'>
                <p className='mt-2 description text-center font-sourceSerif whitespace-pre-line !text-sm !font-bold'>Last updated: June 2025</p>
            </div>

            <div className='my-container mt-12'>
                <Title2 title='Terms and Conditions for Offers and Deals' className='md:mb-0 mb-2' ></Title2>
