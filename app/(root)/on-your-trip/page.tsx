    ...
    return (
        ...
        <div className='w-full'>
            ...
            <div className='mt-12 my-container'>
                <Title2 title='On your trip' className='text-center ' ></Title2>
                <p className='mt-2 description text-center font-sourceSerif whitespace-pre-line'>When you travel with Travelgate, everything is easy and worry-free. We make travel easy so you can just make memories that will last a lifetime. Below are the questions we get asked most often about travelling with Travelgate.</p>
            </div>
