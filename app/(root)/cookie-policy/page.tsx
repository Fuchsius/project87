        ...
        <div className='w-full'>
            ...
            <div className='w-full bg-myred2'>
                <div className='my-container md:h-[396px] h-[163px] flex items-center justify-center'>
                    <h1 className={`text-center text-white lg:text-5xl md:text-[40px] text-[28px] font-bold font-sourceSerif `}>Cookie Policy</h1>
                </div>
            </div>
            ...
            <div className='my-container mt-12'>
                <Title2 title='Cookie Policy' className='md:mb-0 mb-2' ></Title2>
